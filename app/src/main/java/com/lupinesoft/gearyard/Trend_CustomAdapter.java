...
public class Trend_CustomAdapter extends RecyclerView.Adapter<Trend_CustomAdapter.MyViewHolder>{
    Context context;
    List<TrendItem> listItems;

    public Trend_CustomAdapter(Context context, List<TrendItem> listItems) {
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int i) {
        final TrendItem listItem = listItems.get(i);
