...
public class tvCustomAdapter extends RecyclerView.Adapter<tvCustomAdapter.MyViewHolder> implements OnStateListener {
    ...
    public tvCustomAdapter(Context context, List<RecyList> listItems) {
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.buttonImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                view.setOnStateListener(tvCustomAdapter.this);
    ...
    private class submitCartInfo extends AsyncTask<String, Void, String> {
        ...
        String strPid = tvCustomAdapter.strPid;
        @Override
        protected String doInBackground(String... strings) {
            String strUrl = strings[1];
            OkHttpClient client = new OkHttpClient();
