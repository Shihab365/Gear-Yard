...
public class JFU_CustomAdapter extends RecyclerView.Adapter<JFU_CustomAdapter.MyViewHolder>{
    Context context;
    List<JfuItem> listItems;

    public JFU_CustomAdapter(Context context, List<JfuItem> listItems) {
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int i) {
        final JfuItem listItem = listItems.get(i);
