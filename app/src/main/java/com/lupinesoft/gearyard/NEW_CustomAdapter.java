...
public class NEW_CustomAdapter extends RecyclerView.Adapter<NEW_CustomAdapter.MyViewHolder>{
    Context context;
    List<NewItem> listItems;

    public NEW_CustomAdapter(Context context, List<NewItem> listItems) {
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int i) {
        final NewItem listItem = listItems.get(i);
