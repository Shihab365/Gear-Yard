...
public class tvFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        buttonBackArrow = v.findViewById(R.id.tv_button_back_id);
        ...
        recyclerView = v.findViewById(R.id.tv_recyclerview_id);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new GridLayoutManager(getActivity(), 2));

        listItems = new ArrayList<>();

        String urls = "http://100.72.26.84/GYadminPanel/appDB/tv/get_tv_data.php";
                        ...
                        public void run() {
                            ...
                            if(json_string==null){
                                ...
                                try {
                                    ...
                                    adapter = new tvCustomAdapter(getContext(), listItems);
