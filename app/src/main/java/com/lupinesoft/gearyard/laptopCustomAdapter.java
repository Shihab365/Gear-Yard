...
public class laptopCustomAdapter extends RecyclerView.Adapter<laptopCustomAdapter.MyViewHolder> implements OnStateListener {
    ...
    public laptopCustomAdapter(Context context, List<RecyList> listItems) {
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.buttonImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                view.setOnStateListener(laptopCustomAdapter.this);
    ...
    private class submitCartInfo extends AsyncTask<String, Void, String> {
        ...
        String strPid = laptopCustomAdapter.strPid;
        @Override
        protected String doInBackground(String... strings) {
            String strUrl = strings[1];
            OkHttpClient client = new OkHttpClient();
