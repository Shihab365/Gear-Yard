...
public class trendingCustomAdapter extends RecyclerView.Adapter<trendingCustomAdapter.MyViewHolder> implements OnStateListener {
    ...
    public trendingCustomAdapter(Context context, List<RecyList> listItems) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.recy_item_view, viewGroup, false);
    ...
    public void onBindViewHolder(final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.buttonImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                view.setOnStateListener(trendingCustomAdapter.this);
    ...
    private class submitCartInfo extends AsyncTask<String, Void, String> {
        ...
        String strPid = trendingCustomAdapter.strPid;
        @Override
        protected String doInBackground(String... strings) {
            String strUrl = strings[1];
            OkHttpClient client = new OkHttpClient();
